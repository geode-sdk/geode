  ...
  */
  template<typename _InputIterator, typename _ForwardIterator>
	...
	_ValueType2;
      ...
      const bool __assignable = std::is_assignable<_ValueType1, _RefType>::value;
#endif
...
#else
      // trivial types can have deleted assignment
      const bool __assignable = std::is_copy_assignable<_ValueType>::value;
#endif

      __uninitialized_fill<__is_trivial(_ValueType) && __assignable>::
  ...
  */
  template<typename _ForwardIterator, typename _Size, typename _Tp>
	...
	_ValueType;
      ...
      __uninitialized_fill_n<__is_trivial(_ValueType) && __assignable>::
  ...
  template<typename _InputIterator, typename _ForwardIterator, typename _Tp>
    ...
    { return geode::stl::uninitialized_copy(__first, __last, __result); }
  ...
  template<typename _InputIterator1, typename _InputIterator2,
    ...
    __uninitialized_copy_move(_InputIterator1 __first1,
			      ...
			      _Allocator& __alloc)
    {
      _ForwardIterator __mid = __uninitialized_copy_a(__first1, __last1,
							   __result,
							   __alloc);
      __try
	{
  ...
  template<typename _InputIterator1, typename _InputIterator2,
    ...
    __uninitialized_move_copy(_InputIterator1 __first1,
			      ...
			      _Allocator& __alloc)
    {
      _ForwardIterator __mid = __uninitialized_move_a(__first1, __last1,
							   __result,
							   __alloc);
      __try
	{
  ...
  template<typename _InputIterator, typename _ForwardIterator, typename _Tp,
    ...
    __uninitialized_move_fill(_InputIterator __first1, _InputIterator __last1,
			      ...
			      _Allocator& __alloc)
    {
      _ForwardIterator __mid2 = __uninitialized_move_a(__first1, __last1,
							    __first2,
							    __alloc);
      __try
	{
  ...
  template<typename _RandomAccessIterator, typename _Size,
    ...
    { return geode::stl::uninitialized_copy(__first, __first + __n, __result); }
  ...
  */
  template<typename _InputIterator, typename _Size, typename _ForwardIterator>
    ...
    uninitialized_copy_n(_InputIterator __first, _Size __n,
			 _ForwardIterator __result)
    { return __uninitialized_copy_n(__first, __n, __result,
