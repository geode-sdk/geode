...
template <class T>
void doHook(uintptr_t address, T detour, std::string_view display) {
    if (auto hook = Mod::get()->hook(reinterpret_cast<void*>(base::get() + address), detour, std::string(display))) {
...
$execute {
    ...
    doHook(0x44b160, &FMOD_Channel_GetDelay_hook, "FMOD_Channel_GetDelay");
    doHook(0x44b1d4, &FMOD_Channel_GetFadePoints_hook, "FMOD_Channel_GetFadePoints");
    doHook(0x44b1c4, &FMOD_Channel_RemoveFadePoints_hook, "FMOD_Channel_RemoveFadePoints");
    doHook(0x47c63c, &FMOD_Debug_Initialize_hook, "FMOD_Debug_Initialize");
    doHook(0x44a314, &FMOD_Memory_GetStats_hook, "FMOD_Memory_GetStats");
    doHook(0x44a3f8, &FMOD_System_Create_hook, "FMOD_System_Create");
    doHook(0x44aa38, &FMOD_System_LockDSP_hook, "FMOD_System_LockDSP");
    doHook(0x44aa48, &FMOD_System_UnlockDSP_hook, "FMOD_System_UnlockDSP");
    doHook(0x451430, &FMOD_ChannelGroup_getChannel_hook, "FMOD::ChannelGroup::getChannel");
    doHook(0x451358, &FMOD_ChannelGroup_getNumChannels_hook, "FMOD::ChannelGroup::getNumChannels");
    doHook(0x450d64, &FMOD_ChannelGroup_release_hook, "FMOD::ChannelGroup::release");
    doHook(0x450e28, &FMOD_ChannelGroup_addGroup_hook, "FMOD::ChannelGroup::addGroup");
    doHook(0x4fd2cc, &FMOD_ChannelControl_getNumDSPs_hook, "FMOD::ChannelControl::getNumDSPs");
    doHook(0x4fc598, &FMOD_ChannelControl_getDSPClock_hook, "FMOD::ChannelControl::getDSPClock");
    doHook(0x4fed34, &FMOD_ChannelControl_getUserData_hook, "FMOD::ChannelControl::getUserData");
    doHook(0x4fbb90, &FMOD_ChannelControl_setCallback_hook, "FMOD::ChannelControl::setCallback");
    doHook(0x4fec5c, &FMOD_ChannelControl_setUserData_hook, "FMOD::ChannelControl::setUserData");
    doHook(0x4fc9fc, &FMOD_ChannelControl_addFadePoint_hook, "FMOD::ChannelControl::addFadePoint");
    doHook(0x4faf80, &FMOD_ChannelControl_setVolumeRamp_hook, "FMOD::ChannelControl::setVolumeRamp");
    doHook(0x4fab28, &FMOD_ChannelControl_stop_hook, "FMOD::ChannelControl::stop");
    doHook(0x4fd0bc, &FMOD_ChannelControl_addDSP_hook, "FMOD::ChannelControl::addDSP");
    doHook(0x4fcf8c, &FMOD_ChannelControl_getDSP_hook, "FMOD::ChannelControl::getDSP");
    doHook(0x4fb308, &FMOD_ChannelControl_getPitch_hook, "FMOD::ChannelControl::getPitch");
    doHook(0x4fc6f0, &FMOD_ChannelControl_setDelay_hook, "FMOD::ChannelControl::setDelay");
    doHook(0x4fb220, &FMOD_ChannelControl_setPitch_hook, "FMOD::ChannelControl::setPitch");
    doHook(0x4facd4, &FMOD_ChannelControl_getPaused_hook, "FMOD::ChannelControl::getPaused");
    doHook(0x4faea0, &FMOD_ChannelControl_getVolume_hook, "FMOD::ChannelControl::getVolume");
    doHook(0x4fd1ec, &FMOD_ChannelControl_removeDSP_hook, "FMOD::ChannelControl::removeDSP");
    doHook(0x4fabf4, &FMOD_ChannelControl_setPaused_hook, "FMOD::ChannelControl::setPaused");
    doHook(0x4fadb4, &FMOD_ChannelControl_setVolume_hook, "FMOD::ChannelControl::setVolume");
    doHook(0x47f420, &FMOD_DSP_getMeteringInfo_hook, "FMOD::DSP::getMeteringInfo");
    doHook(0x47e010, &FMOD_DSP_setParameterBool_hook, "FMOD::DSP::setParameterBool");
    doHook(0x47dde0, &FMOD_DSP_setParameterFloat_hook, "FMOD::DSP::setParameterFloat");
    doHook(0x47f1d0, &FMOD_DSP_setMeteringEnabled_hook, "FMOD::DSP::setMeteringEnabled");
    doHook(0x47c6c4, &FMOD_DSP_release_hook, "FMOD::DSP::release");
    doHook(0x4b7c90, &FMOD_Sound_getOpenState_hook, "FMOD::Sound::getOpenState");
    doHook(0x4b8c70, &FMOD_Sound_setLoopCount_hook, "FMOD::Sound::setLoopCount");
    doHook(0x4b60b0, &FMOD_Sound_release_hook, "FMOD::Sound::release");
    doHook(0x4b7580, &FMOD_Sound_getLength_hook, "FMOD::Sound::getLength");
    doHook(0x4c3284, &FMOD_System_getVersion_hook, "FMOD::System::getVersion");
    doHook(0x4c3768, &FMOD_System_createSound_hook, "FMOD::System::createSound");
    doHook(0x4c354c, &FMOD_System_getCPUUsage_hook, "FMOD::System::getCPUUsage");
    doHook(0x4c2ff0, &FMOD_System_mixerResume_hook, "FMOD::System::mixerResume");
    doHook(0x4c38ec, &FMOD_System_createStream_hook, "FMOD::System::createStream");
    doHook(0x4c2f2c, &FMOD_System_mixerSuspend_hook, "FMOD::System::mixerSuspend");
    doHook(0x4c3b98, &FMOD_System_createDSPByType_hook, "FMOD::System::createDSPByType");
    doHook(0x4c03e4, &FMOD_System_getDSPBufferSize_hook, "FMOD::System::getDSPBufferSize");
    doHook(0x4c02bc, &FMOD_System_setDSPBufferSize_hook, "FMOD::System::setDSPBufferSize");
    doHook(0x4c0140, &FMOD_System_getSoftwareFormat_hook, "FMOD::System::getSoftwareFormat");
    doHook(0x4bffdc, &FMOD_System_setSoftwareFormat_hook, "FMOD::System::setSoftwareFormat");
    doHook(0x4c3cc0, &FMOD_System_createChannelGroup_hook, "FMOD::System::createChannelGroup");
    doHook(0x4c2520, &FMOD_System_getStreamBufferSize_hook, "FMOD::System::getStreamBufferSize");
    doHook(0x4c1de0, &FMOD_System_init_hook, "FMOD::System::init");
    doHook(0x4c1f34, &FMOD_System_close_hook, "FMOD::System::close");
    doHook(0x4c200c, &FMOD_System_update_hook, "FMOD::System::update");
    doHook(0x4c4b94, &FMOD_System_lockDSP_hook, "FMOD::System::lockDSP");
    doHook(0x4bf688, &FMOD_System_release_hook, "FMOD::System::release");
    doHook(0x4c3fe8, &FMOD_System_playSound_hook, "FMOD::System::playSound");
    doHook(0x4c4c48, &FMOD_System_unlockDSP_hook, "FMOD::System::unlockDSP");
    doHook(0x44cf08, &FMOD_Channel_getPosition_hook, "FMOD::Channel::getPosition");
    doHook(0x44cde0, &FMOD_Channel_setPosition_hook, "FMOD::Channel::setPosition");
    doHook(0x44d670, &FMOD_Channel_setLoopCount_hook, "FMOD::Channel::setLoopCount");
    doHook(0x44d9c0, &FMOD_Channel_getLoopPoints_hook, "FMOD::Channel::getLoopPoints");
    doHook(0x44d82c, &FMOD_Channel_setLoopPoints_hook, "FMOD::Channel::setLoopPoints");
    doHook(0x44d4a8, &FMOD_Channel_getCurrentSound_hook, "FMOD::Channel::getCurrentSound");
};
#endif
