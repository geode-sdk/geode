...
VersionInfo::VersionInfo(std::string const& versionString) : VersionInfo(versionString.c_str()) {}

int VersionInfo::getMajor() const {
    return this->m_major;
}

int VersionInfo::getMinor() const {
    return this->m_minor;
}

int VersionInfo::getPatch() const {
    return this->m_patch;
}
...
bool VersionInfo::match(VersionInfo const& other) const {
    return other.m_major == this->m_major && other.m_minor == this->m_minor &&
        other.m_patch == this->m_patch;
}

bool VersionInfo::match(VersionInfo const& other, VersionInfo::Compare compare) const {
    switch (compare) {
