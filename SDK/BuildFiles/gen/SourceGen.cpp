...
struct address_of_t<(fixori_member{global_index})(&{class_name}::{function_name})> {{
	...
	char const* declare_meta_member_function = "geode::core::meta::Function<pure{global_index}, geode::core::meta::x86::{convention}>({{temp_name_find_better::address{global_index}()}})(addresser::thunkAdjust((member{global_index})(&{class_name}::{function_name}), this){parameters})";
