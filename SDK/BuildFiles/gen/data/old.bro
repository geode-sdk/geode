...
class BoomListView : cocos2d::CCLayer, TableViewDataSource, TableViewDelegate {
	...
	bool init(cocos2d::CCArray*, float, float, int, BoomListType) = mac 0x18ee00, win 0x10c20;
	...
	virtual void cellForRowAtIndexPath(CCIndexPath&, TableView*) = mac 0x18f100, win 0x10e70;
...
class CCMenuItemSpriteExtra : cocos2d::CCMenuItemSprite {
	...
	PAD = win 0x54;
	float m_colorDip;			// 0x158
	cocos2d::CCPoint m_destPosition;	// 0x15c
	cocos2d::CCPoint m_offset;	// 0x164
	MenuAnimationType m_animationType;	// 0x16c
	cocos2d::CCPoint m_startPosition;	// 0x170
}
...
class CCScrollLayerExt : cocos2d::CCLayer {
	...
	virtual void ccTouchMoved(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x236300, win 0x1bcc0;
	virtual void ccTouchEnded(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x236020, win 0x1baa0;
	virtual void ccTouchCancelled(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x2362a0, win 0x1bce0;
	...
	CCScrollLayerExt(cocos2d::CCRect rect) = win 0x1b020, mac 0x235130;
...
class CCScrollLayerExtDelegate {
	virtual void scrllViewWillBeginDecelerating(CCScrollLayerExt*) {} // You've read that right! 
...
class SimplePlayer : cocos2d::CCSprite {
	...
	void updateColors() = mac 0x1ba1f0, win 0x12c440;
...
class SliderThumb : cocos2d::CCMenuItemImage {
	...
	void setValue(float val) = win 0x2e1b0, mac 0x18ce80;
	// float getValue() {
