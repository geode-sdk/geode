...
class AccountLayer : GJDropDownLayer, GJAccountDelegate, GJAccountBackupDelegate, GJAccountSyncDelegate, FLAlertLayerProtocol {
	void create() = mac 0x0, win 0x0, ios 0x0;
	void createToggleButton(std::string, cocos2d::SEL_MenuHandler, bool, cocos2d::CCMenu*, cocos2d::CCPoint) = mac 0x0, win 0x0, ios 0x0;
...
class BoomListView : cocos2d::CCLayer, TableViewDataSource, TableViewDelegate {
	...
	void draw() = mac 0x18f790, win 0x0, ios 0x0;
...
class EditorPauseLayer : FLAlertLayer, CCBlockLayer, FLAlertLayerProtocol {
...
class EditorUI : cocos2d::CCLayer, FLAlertLayerProtocol, ColorSelectDelegate, GJRotationControlDelegate, GJScaleControlDelegate, MusicDownloadDelegate {
	...
	void selectObject(GameObject* obj, bool idk) = mac 0x0, win 0x86250, ios 0x0;
	...
	void updateCreateMenu(bool updateTab) = mac 0x0, win 0x85530, ios 0x0;
	void toggleMode(cocos2d::CCObject* pSender) = mac 0x0, win 0x7ad20, ios 0x0;
	void zoomIn(cocos2d::CCObject* pSender) = mac 0x0, win 0x877c0, ios 0x0;
	void zoomOut(cocos2d::CCObject* pSender) = mac 0x0, win 0x87830, ios 0x0;
	void rotateObjects(cocos2d::CCArray* objects, float angle, cocos2d::CCPoint center) = mac 0x0, win 0x8ee80, ios 0x0;
	void updateGridNodeSize() = mac 0x0, win 0x78f60, ios 0x0;
	void updateSpecialUIElements() = mac 0x0, win 0x87030, ios 0x0;
	void constrainGameLayerPosition(float x, float y) = mac 0x0, win 0x8f920, ios 0x0;
	void moveGameLayer(cocos2d::CCPoint const& pos) = mac 0x0, win 0x79290, ios 0x0;
	void showUI(bool show) = mac 0x0, win 0x87180, ios 0x0;
	...
	void moveObjectCall(EditCommand pSender) = mac 0x0, win 0x8db30, ios 0x0;
	void transformObjectCall(EditCommand pSender) = mac 0x0, win 0x8def0, ios 0x0;
	void onDeleteSelected(cocos2d::CCObject* pSender) = mac 0x0, win 0x7bf50, ios 0x0;
	void onCopy(cocos2d::CCObject* pSender) = mac 0x0, win 0x87fb0, ios 0x0;
	void onPaste(cocos2d::CCObject* pSender) = mac 0x0, win 0x880c0, ios 0x0;
	void toggleEnableRotate(cocos2d::CCObject* pSender) = mac 0x0, win 0x860d0, ios 0x0;
	void toggleFreeMove(cocos2d::CCObject* pSender) = mac 0x0, win 0x85eb0, ios 0x0;
	void toggleSwipe(cocos2d::CCObject* pSender) = mac 0x0, win 0x85dd0, ios 0x0;
	void toggleSnap(cocos2d::CCObject* pSender) = mac 0x0, win 0x85fa0, ios 0x0;
	void onPlayback(cocos2d::CCObject* pSender) = mac 0x0, win 0x87340, ios 0x0;
	void onPlaytest(cocos2d::CCObject* pSender) = mac 0x0, win 0x87600, ios 0x0;
	void onStopPlaytest(cocos2d::CCObject* pSender) = mac 0x0, win 0x876e0, ios 0x0;
	void onGroupUp(cocos2d::CCObject* pSender) = mac 0x0, win 0x8d780, ios 0x0;
	void onGroupDown(cocos2d::CCObject* pSender) = mac 0x0, win 0x8d7e0, ios 0x0;
	void selectBuildTab(int tab) = mac 0x0, win 0x88810, ios 0x0;
	void onPause(cocos2d::CCObject* pSender) = mac 0x0, win 0x78020, ios 0x0;
	...
	void keyUp(cocos2d::enumKeyCodes key) = mac 0x0, win 0x92180, ios 0x0;
...
class GameObject : CCSpritePlus {
	...
	virtual void setStartPos(cocos2d::CCPoint) = mac 0x2fa520, win 0x0, ios 0x0;
...
class HardStreak : cocos2d::CCDrawNode {
	...
	void addPoint(cocos2d::CCPoint) = mac 0x5c950, win 0x0, ios 0x0;
...
class TableViewCell : cocos2d::CCLayer {
	...
	TableViewCell(const char*, float, float) = mac 0x383de0, win 0x32e70, ios 0x0;
...
class UILayer {
	...
	void onCheck(cocos2d::CCObject* pSender) = mac 0x0, win 0x25fb60, ios 0x0;
	void onDeleteCheck(cocos2d::CCObject* pSender) = mac 0x0, win 0x25fc90, ios 0x0;
	void onPause(cocos2d::CCObject* pSender) = mac 0x0, win 0x25fad0, ios 0x0;
	void keyDown(cocos2d::enumKeyCodes key) = mac 0x0, win 0x25f890, ios 0x0;
	void keyUp(cocos2d::enumKeyCodes key) = mac 0x0, win 0x25fa10, ios 0x0;
