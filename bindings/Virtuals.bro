class ArtistCell : TableViewCell {
	virtual void init() = mac 0x11c7c0, ios 0xa5588;
...
class GJUserCell : TableViewCell, FLAlertLayerProtocol, UploadPopupDelegate, UploadActionDelegate {
	virtual void init() = mac 0x11e180, ios 0xa6374;
...
class GameObject : CCSpritePlus {
	...
	virtual void initWithTexture(cocos2d::CCTexture2D*) = mac 0x2f56a0, ios 0x16ea20;
	virtual void setChildColor(cocos2d::_ccColor3B const&) = mac 0x341f20, ios 0x19c354;
	...
	virtual void setObjectColor(cocos2d::_ccColor3B const&) = mac 0x341c90, ios 0x19c150;
	virtual void setGlowColor(cocos2d::_ccColor3B const&) = mac 0x341ed0, ios 0x19c2f8;
...
class HardStreak : cocos2d::CCDrawNode {
	virtual void init() = mac 0x5c090, ios 0x3746c;
};
...
class ShardsPage : FLAlertLayer {
	virtual void init() = mac 0x27d610, ios 0x286c5c;
...
class CCCountdown : cocos2d::CCSprite {
	virtual void init() = mac 0x468870;
...
class CCMoveCNode : cocos2d::CCNode {
	virtual void init() = mac 0x18b3d0, ios 0x14c3c;
};
...
class CommentCell : TableViewCell, LikeItemDelegate, FLAlertLayerProtocol {
	virtual void init() = mac 0x11ce80, ios 0xa5878;
...
class DialogLayer : cocos2d::CCLayerColor, TextAreaDelegate {
	...
	virtual void ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x205790, ios 0x465e8;
...
class GJGameLevel : cocos2d::CCNode {
	...
	virtual void canEncode() = mac 0x2ddae0, ios 0x71134;
	virtual void init() = mac 0x2db310, ios 0x6f180;
};
...
class GJScoreCell : TableViewCell, FLAlertLayerProtocol {
	virtual void init() = mac 0x11d710, ios 0xa5e90;
...
class GJUserScore : cocos2d::CCNode {
	virtual void init() = mac 0x2de5a0, ios 0x71a38;
};
...
class GameManager : GManager {
	...
	virtual void init() = mac 0x1c2ec0, ios 0x232218;
...
class MapPackCell : TableViewCell {
	virtual void init() = mac 0x11a9c0, ios 0xa3f5c;
...
class RewardsPage : FLAlertLayer, FLAlertLayerProtocol, GJRewardDelegate {
	virtual void init() = mac 0xf3800, ios 0x123118;
...
class SecretLayer : cocos2d::CCLayer, TextInputDelegate, FLAlertLayerProtocol {
	virtual void init() = mac 0x363340, ios 0x29f518;
...
class AccountLayer : GJDropDownLayer, GJAccountDelegate, GJAccountBackupDelegate, GJAccountSyncDelegate, FLAlertLayerProtocol {
	...
	virtual void backupAccountFinished() = mac 0x830e0, ios 0xde5d0;
	virtual void backupAccountFailed(BackupAccountError) = mac 0x832d0, ios 0xde748;
	virtual void syncAccountFinished() = mac 0x83490, ios 0xde8b0;
	virtual void syncAccountFailed(BackupAccountError) = mac 0x83630, ios 0xdea1c;
	virtual void accountStatusChanged() = mac 0x830b0, ios 0xde5bc;
...
class CCBlockLayer : cocos2d::CCLayerColor {
	virtual void init() = mac 0x2a59c0, ios 0x45490;
	virtual void draw() = mac 0x2a5c20, ios 0x456c4;
	virtual void ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x2a5c50, ios 0x45700;
...
class CCLightFlash : cocos2d::CCNode {
	virtual void init() = mac 0x2958f0, ios 0x1fdd0;
};
...
class CCSpritePlus : cocos2d::CCSprite {
	...
	virtual void initWithTexture(cocos2d::CCTexture2D*) = mac 0x248690, ios 0x119000;
	virtual void initWithSpriteFrameName(char const*) = mac 0x248670, ios 0x118ff4;
...
class CreatorLayer : cocos2d::CCLayer, cocos2d::CCSceneTransitionDelegate, DialogDelegate {
	virtual void init() = mac 0x141c10, ios 0x733b4;
...
class FLAlertLayer : cocos2d::CCLayerColor {
	...
	virtual void ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x25ee40, ios 0x1fee48;
...
class GJRewardItem : cocos2d::CCObject {
	...
	virtual void canEncode() = mac 0x4d850, ios 0x252d74;
};
...
class PlayerObject : GameObject {
	...
	virtual void setColor(cocos2d::_ccColor3B const&) = mac 0x22cdf0, ios 0x150fb0;
...
class SecretLayer2 : cocos2d::CCLayer, TextInputDelegate, FLAlertLayerProtocol, DialogDelegate {
	virtual void init() = mac 0x25fe70, ios 0x227d08;
...
class SecretLayer3 : cocos2d::CCLayer, DialogDelegate {
	virtual void init() = mac 0x267040, ios 0x22d8d4;
...
class SecretLayer4 : cocos2d::CCLayer, TextInputDelegate, FLAlertLayerProtocol, DialogDelegate {
	virtual void init() = mac 0x1ed640, ios 0x25dd84;
...
class SimplePlayer : cocos2d::CCSprite {
	...
	virtual void setColor(cocos2d::_ccColor3B const&) = mac 0x1bc9b0, ios 0x226dd8;
};

class SlideInLayer : cocos2d::CCLayerColor {
	virtual void init() = mac 0x138cf0;
	virtual void draw() = mac 0x1394a0;
	virtual void ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x1394d0;
...
class ExtendedLayer : cocos2d::CCLayer {
	virtual void init() = mac 0x1e41e0, ios 0xbd198;
	virtual void setPosition(cocos2d::CCPoint const&) = mac 0x1e41f0, ios 0xbd19c;
};

class GJChestSprite : cocos2d::CCSprite {
	virtual void setColor(cocos2d::_ccColor3B const&) = mac 0xf8270, ios 0x1272f4;
};
...
class GJGarageLayer : cocos2d::CCLayer, TextInputDelegate, FLAlertLayerProtocol, GameRateDelegate, ListButtonBarDelegate, DialogDelegate {
	virtual void init() = mac 0x1b4980, ios 0x22045c;
...
class GJMessageCell : TableViewCell, FLAlertLayerProtocol, UploadPopupDelegate, UploadActionDelegate {
	virtual void init() = mac 0x11fc00, ios 0xa78d8;
...
class GJRequestCell : TableViewCell, FLAlertLayerProtocol, UploadPopupDelegate, UploadActionDelegate {
	virtual void init() = mac 0x11f080, ios 0xa709c;
...
class GJRobotSprite : CCAnimatedSprite {
	virtual void init() = mac 0x34ad50, ios 0x161634;
...
class GJSpriteColor : cocos2d::CCNode {
	virtual void init() = mac 0x343c90, ios 0x19d6a0;
};

class GJUserMessage : cocos2d::CCNode {
	virtual void init() = mac 0x2debf0, ios 0x71da0;
};
...
class LoadingCircle : cocos2d::CCLayerColor {
	virtual void init() = mac 0x277f00, ios 0x27f280;
	virtual void draw() = mac 0x278170, ios 0x27f4e4;
	virtual void ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x2781d0;
...
class MenuGameLayer : cocos2d::CCLayer {
	...
	virtual void init() = mac 0x28f150, ios 0x27f654;
	virtual void ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x290650, ios 0x280898;
...
class MyLevelsLayer : cocos2d::CCLayer {
	virtual void init() = mac 0x35470, ios 0x81b90;
	virtual void keyBackClicked() = mac 0x35b90, ios 0x8222c;
};

class ObjectDecoder : cocos2d::CCNode {
	virtual void init() = mac 0x437f80, ios 0x1589dc;
};

class ObjectManager : cocos2d::CCNode {
	virtual void init() = mac 0x43b280, ios 0x168d48;
};

class ObjectToolbox : cocos2d::CCNode {
	virtual void init() = mac 0x3b2d80, ios 0x1b092c;
};
...
class TutorialLayer : FLAlertLayer {
	virtual void init() = mac 0x286e00, ios 0x11e860;
...
class ChallengesPage : FLAlertLayer, FLAlertLayerProtocol, GJChallengeDelegate, CurrencyRewardDelegate {
	virtual void init() = mac 0x1db520, ios 0x20e64;
...
class CustomSongCell : TableViewCell {
	virtual void init() = mac 0x11c440, ios 0xa53a0;
...
class GJOptionsLayer : FLAlertLayer {
	virtual void init() = mac 0x145c60, ios 0x200ce8;
...
class GJRewardObject : cocos2d::CCObject {
	...
	virtual void canEncode() = mac 0x4d1f0, ios 0x2529b0;
};

class GJScaleControl : cocos2d::CCLayer {
	virtual void init() = mac 0x31b30, ios 0x2c4d5c;
	virtual void ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x31d30, ios 0x2c4f08;
...
class GJSpiderSprite : GJRobotSprite {
	virtual void init() = mac 0x34c700, ios 0x162e74;
};
...
class ScrollingLayer : cocos2d::CCLayerColor {
	...
	virtual void ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x41ae10, ios 0x1198a8;
...
class SongInfoObject : cocos2d::CCNode {
	...
	virtual void canEncode() = mac 0x2f2da0, ios 0xd4b8c;
};

class StartPosObject : EffectGameObject {
	virtual void init() = mac 0xda8a0, ios 0x27e060;
	virtual void getSaveString() = mac 0xda960, ios 0x27e0f0;
};
...
class AchievementCell : TableViewCell {
	virtual void init() = mac 0x117730, ios 0xa1650;
...
class BoomScrollLayer : cocos2d::CCLayer {
	...
	virtual void ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x1e3c40, ios 0xbccec;
...
class CCNodeContainer : cocos2d::CCNode {
	virtual void init() = mac 0xba950, ios 0x13aa24;
...
class CCSpriteWithHue : cocos2d::CCSprite {
	...
	virtual void initWithTexture(cocos2d::CCTexture2D*) = mac 0x359d10, ios 0x103ff8;
	virtual void initWithTexture(cocos2d::CCTexture2D*, cocos2d::CCRect const&) = mac 0x359d80, ios 0x104074;
	virtual void initWithTexture(cocos2d::CCTexture2D*, cocos2d::CCRect const&, bool) = mac 0x359b80, ios 0x103ebc;
	virtual void initWithSpriteFrame(cocos2d::CCSpriteFrame*) = mac 0x359da0, ios 0x104084;
	virtual void updateColor() = mac 0x359f70, ios 0x104148;
};

class CCTextInputNode : cocos2d::CCLayer, cocos2d::CCIMEDelegate, cocos2d::CCTextFieldDelegate {
	virtual void visit() = mac 0x5d380, ios 0xe279c;
	virtual void ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x5ec80, ios 0xe3e0c;
...
class EndPortalObject : GameObject {
	virtual void init() = mac 0x1da980, ios 0x2c62c4;
...
class FileSaveManager : GManager {
	virtual void init() = mac 0x6360;
	virtual void firstLoad() = mac 0x6390;
};

class GJBaseGameLayer : cocos2d::CCLayer, TriggerEffectDelegate {
	virtual void init() = mac 0xafc90, ios 0x1338e8;
	...
	virtual void updateColor(cocos2d::_ccColor3B, float, int, bool, float, cocos2d::_ccHSVValue, int, bool, int, EffectGameObject*) = mac 0xb7420, ios 0x138530;
...
class GJChallengeItem : cocos2d::CCObject {
	...
	virtual void canEncode() = mac 0x4e020, ios 0x2533f8;
};

class GJDropDownLayer : cocos2d::CCLayerColor {
	virtual void draw() = mac 0x352910, ios 0x29827c;
	virtual void ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x352940, ios 0x2982b8;
...
class GJEffectManager : cocos2d::CCNode {
	virtual void init() = mac 0x180230, ios 0xdf5c;
};

class GJFriendRequest : cocos2d::CCNode {
	virtual void init() = mac 0x2dea00, ios 0x71c5c;
};

class GJObjectDecoder : cocos2d::CCNode, ObjectDecoderDelegate {
	virtual void init() = mac 0x41e780, ios 0x13f9f8;
...
class LabelGameObject : EffectGameObject {
	virtual void init() = mac 0xdb990, ios 0x27ea8c;
...
class MoreSearchLayer : FLAlertLayer, TextInputDelegate {
	virtual void init() = mac 0x3896b0, ios 0x34f48;
...
class SetupPulsePopup : FLAlertLayer, cocos2d::extension::ColorPickerDelegate, TextInputDelegate, GJSpecialColorSelectDelegate {
	...
	virtual void colorValueChanged(cocos2d::_ccColor3B) = mac 0x1ec680, ios 0x29d574;
...
class TopArtistsLayer : FLAlertLayer, OnlineListDelegate {
	virtual void init() = mac 0x192c30, ios 0x104f34;
...
class AccountHelpLayer : GJDropDownLayer, GJAccountDelegate, FLAlertLayerProtocol {
	...
	virtual void accountStatusChanged() = mac 0x84a20, ios 0xdf8ac;
...
class CCPartAnimSprite : cocos2d::CCSprite {
	...
	virtual void isFrameDisplayed(cocos2d::CCSpriteFrame*) = mac 0x1bfc20, ios 0x3da6c;
	virtual void displayFrame() = mac 0x1bfc40, ios 0x3da84;
};

class CCScrollLayerExt : cocos2d::CCLayer {
	virtual void visit() = mac 0x236550, ios 0x220018;
	virtual void ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x235ef0, ios 0x21fa58;
...
class CheckpointObject : cocos2d::CCNode {
	virtual void init() = mac 0x80920, ios 0xb98c8;
};
...
class ColorSelectPopup : FLAlertLayer, cocos2d::extension::ColorPickerDelegate, TextInputDelegate, GJSpecialColorSelectDelegate {
	...
	virtual void colorValueChanged(cocos2d::_ccColor3B) = mac 0x423320, ios 0x2dbb8c;
...
class FollowRewardPage : FLAlertLayer, FLAlertLayerProtocol, GameRateDelegate {
	virtual void init() = mac 0x22f4a0, ios 0x2e08e8;
...
class GJAccountManager : cocos2d::CCNode {
	virtual void init() = mac 0x879d0, ios 0x284c04;
};

class GJFlyGroundLayer : GJGroundLayer {
	virtual void init() = mac 0x356c00;
};

class GJLevelScoreCell : TableViewCell {
	virtual void init() = mac 0x11dbb0, ios 0xa61a0;
...
class GameLevelManager : cocos2d::CCNode {
	virtual void init() = mac 0x2b7ba0, ios 0x518b8;
};
...
class GameSoundManager : cocos2d::CCNode {
	virtual void init() = mac 0x3611d0, ios 0x1a2a60;
};

class GameStatsManager : cocos2d::CCNode {
	virtual void init() = mac 0x39330, ios 0x2433d0;
};

class GhostTrailEffect : cocos2d::CCNode {
	virtual void init() = mac 0x360730, ios 0x213688;
	virtual void draw() = mac 0x360d20, ios 0x213c00;
};

class KeybindingsLayer : FLAlertLayer {
	virtual void init() = mac 0x375890;
...
class LevelEditorLayer : GJBaseGameLayer, LevelSettingsDelegate {
	...
	virtual void updateColor(cocos2d::_ccColor3B, float, int, bool, float, cocos2d::_ccHSVValue, int, bool, int, EffectGameObject*) = mac 0x9c200, ios 0x268d08;
...
class LevelSearchLayer : cocos2d::CCLayer, TextInputDelegate, FLAlertLayerProtocol, DemonFilterDelegate {
	virtual void init() = mac 0x384770, ios 0x31358;
...
class MoreOptionsLayer : FLAlertLayer, TextInputDelegate, GooglePlayDelegate {
	virtual void init() = mac 0x43f470, ios 0x8779c;
...
class NumberInputLayer : FLAlertLayer {
	virtual void init() = mac 0x255ff0, ios 0x952f4;
...
class PlayerCheckpoint : cocos2d::CCNode {
	virtual void init() = mac 0x807a0, ios 0xb97dc;
};
...
class SliderTouchLogic : cocos2d::CCMenu {
	virtual void ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x18d630, ios 0x21113c;
...
class AccountLoginLayer : FLAlertLayer, TextInputDelegate, GJAccountLoginDelegate, FLAlertLayerProtocol {
	...
	virtual void loginAccountFinished(int, int) = mac 0x25ce20, ios 0x42d90;
	virtual void loginAccountFailed(AccountError) = mac 0x25d190, ios 0x42fc4;
};
...
class ColorActionSprite : cocos2d::CCNode {
	virtual void init() = mac 0x175370, ios 0x9b6c;
};

class DungeonBarsSprite : cocos2d::CCNode {
	virtual void init() = mac 0x26c2b0, ios 0x231e8c;
...
class GJRotationControl : cocos2d::CCLayer {
	virtual void init() = mac 0x31510, ios 0x2c4914;
	virtual void draw() = mac 0x31ac0, ios 0x2c4ce8;
	virtual void ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x31790, ios 0x2c4b20;
...
class GooglePlayManager : cocos2d::CCNode {
	virtual void init() = mac 0x246130, ios 0x26a84;
};
...
class LocalLevelManager : GManager {
	virtual void init() = mac 0x35dfc0, ios 0x127888;
...
class PromoInterstitial : FLAlertLayer {
	virtual void ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x169e80;
...
class SecretNumberLayer : cocos2d::CCLayer {
	virtual void init() = mac 0x266c30, ios 0x22d758;
};
...
class TextInputDelegate {
	...
	virtual void allowTextInput(CCTextInputNode*) = mac 0x6210, ios 0x182f8;
};
...
class ColorChannelSprite : cocos2d::CCSprite {
	virtual void init() = mac 0x16deb0, ios 0x6e04;
};
...
class EditorOptionsLayer : GJOptionsLayer {
	virtual void init() = mac 0x147420, ios 0x2024e4;
...
class AchievementNotifier : cocos2d::CCNode {
	virtual void init() = mac 0x464e90, ios 0x13f488;
};
...
class GravityEffectSprite : cocos2d::CCSprite {
	virtual void init() = mac 0x80b20, ios 0xb99b8;
...
class LevelSettingsObject : cocos2d::CCNode {
	virtual void init() = mac 0xa5690, ios 0x26ebb8;
};
...
class AccountRegisterLayer : FLAlertLayer, TextInputDelegate, GJAccountRegisterDelegate, FLAlertLayerProtocol {
	virtual void init() = mac 0x2575d0, ios 0x3f908;
	...
	virtual void allowTextInput(CCTextInputNode*) = mac 0x25b5d0, ios 0x41d70;
...
class CommunityCreditsPage : FLAlertLayer {
	virtual void init() = mac 0x19b2b0, ios 0xff360;
...
class CustomizeObjectLayer : FLAlertLayer, TextInputDelegate, HSVWidgetPopupDelegate, ColorSelectDelegate, ColorSetupDelegate {
	...
	virtual void hsvPopupClosed(HSVWidgetPopup*, cocos2d::_ccHSVValue) = mac 0xe1050, ios 0x30b38;
...
class MusicDownloadManager : cocos2d::CCNode, PlatformDownloadDelegate {
	virtual void init() = mac 0x2ef100, ios 0xd1670;
};

class ParentalOptionsLayer : FLAlertLayer {
	virtual void init() = mac 0x445da0, ios 0x8d484;
...
class CreateGuidelinesLayer : FLAlertLayer, FLAlertLayerProtocol {
	...
	virtual void ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x299dd0, ios 0x3c840;
...
class MoreVideoOptionsLayer : FLAlertLayer {
	virtual void init() = mac 0x444150, ios 0x8b7e0;
...
class DemonFilterSelectLayer : FLAlertLayer {
	virtual void init() = mac 0x38b9d0, ios 0x36d20;
...
class Slider : cocos2d::CCLayer {
	virtual void ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x18e2e0, ios 0x211700;
...
class UILayer : cocos2d::CCLayerColor, cocos2d::CCKeyboardDelegate {
	virtual void init() = mac 0x27fe40, ios 0x2b994;
	virtual void draw() = mac 0x280980, ios 0x2c094;
	virtual void ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x280990, ios 0x2c098;
...
class EditorUI : cocos2d::CCLayer, FLAlertLayerProtocol, ColorSelectDelegate, GJRotationControlDelegate, GJScaleControlDelegate, MusicDownloadDelegate {
	...
	virtual void ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x2ed60, ios 0x2c314c;
...
class GManager : cocos2d::CCNode {
	virtual void init() = mac 0x26ee00, ios 0x165418;
...
class GameCell : TableViewCell {
	virtual void init() = mac 0x18f980, ios 0x12cd0c;
	virtual void draw() = mac 0x18fa40, ios 0x12cd50;
};

class ListCell : TableViewCell {
	virtual void init() = mac 0x18f7a0, ios 0x12cc80;
	virtual void draw() = mac 0x18f840, ios 0x12cc88;
};

class SongCell : TableViewCell {
	virtual void init() = mac 0x11c200, ios 0xa5274;
...
class GJComment : cocos2d::CCNode {
	virtual void init() = mac 0x2dfec0, ios 0x728b0;
};

class GJMapPack : cocos2d::CCNode {
	virtual void init() = mac 0x2de0e0, ios 0x71740;
};
...
class KeysLayer : cocos2d::CCLayer, FLAlertLayerProtocol, DialogDelegate {
	virtual void init() = mac 0x44d340, ios 0x254898;
...
class LevelCell : TableViewCell {
	virtual void init() = mac 0x117a40, ios 0xa1864;
	virtual void draw() = mac 0x11a4d0, ios 0xa3d68;
};

class LevelPage : cocos2d::CCLayer, DialogDelegate {
	virtual void ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x23cd90, ios 0x2cab10;
...
class MenuLayer : cocos2d::CCLayer, FLAlertLayerProtocol, GooglePlayDelegate {
	virtual void init() = mac 0x1d14b0, ios 0x19e6d4;
...
class PlayLayer : GJBaseGameLayer, CCCircleWaveDelegate, CurrencyRewardDelegate, DialogDelegate {
	...
	virtual void updateColor(cocos2d::_ccColor3B, float, int, bool, float, cocos2d::_ccHSVValue, int, bool, int, EffectGameObject*) = mac 0x7c7f0, ios 0xb6b1c;
...
class StatsCell : TableViewCell {
	virtual void init() = mac 0x11b100, ios 0xa45f0;
...
class TableView : CCScrollLayerExt, CCScrollLayerExtDelegate {
	...
	virtual void ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = mac 0x380120, ios 0x21de24;
...
class cocos2d::CCNodeRGBA : cocos2d::CCNode, cocos2d::CCRGBAProtocol {
	...
	virtual auto setColor(cocos2d::_ccColor3B const&) = mac 0x125060, ios 0x15f988;
...
class cocos2d::CCAtlasNode : cocos2d::CCNodeRGBA, cocos2d::CCTextureProtocol {
	...
	virtual auto setColor(cocos2d::_ccColor3B const&) = mac 0x1a50b0;
...
class cocos2d::CCLightning : cocos2d::CCNode, cocos2d::CCRGBAProtocol {
	...
	virtual auto setColor(cocos2d::_ccColor3B const&) = mac 0x34d4e0, ios 0x254588;
	virtual auto updateDisplayedColor(cocos2d::_ccColor3B const&) = mac 0x34d5e0, ios 0x254614;
...
class cocos2d::XmlSaxHander : tinyxml2::XMLVisitor {
	virtual auto VisitEnter(tinyxml2::XMLElement const&, tinyxml2::XMLAttribute const*) = mac 0xbacf0;
	virtual auto VisitExit(tinyxml2::XMLElement const&) = mac 0xbaff0;
	virtual auto Visit(tinyxml2::XMLText const&) = mac 0xbb040;
	virtual auto Visit(tinyxml2::XMLUnknown const&) = mac 0xbb2a0;
};
...
class cocos2d::CCLabelBMFont : cocos2d::CCSpriteBatchNode, cocos2d::CCLabelProtocol, cocos2d::CCRGBAProtocol {
	...
	virtual auto setColor(cocos2d::_ccColor3B const&) = mac 0x348c70, ios 0x21a668;
	virtual auto updateDisplayedColor(cocos2d::_ccColor3B const&) = mac 0x349210, ios 0x21a968;
...
class cocos2d::CCTextFieldTTF : cocos2d::CCLabelTTF, cocos2d::CCIMEDelegate {
	...
	virtual auto setColorSpaceHolder(cocos2d::_ccColor3B const&) = mac 0x126aa0, ios 0x1293e8;
...
class cocos2d::CCLayerGradient : cocos2d::CCLayerColor {
	...
	virtual auto initWithColor(cocos2d::_ccColor4B const&, cocos2d::_ccColor4B const&) = mac 0x2752b0;
	virtual auto initWithColor(cocos2d::_ccColor4B const&, cocos2d::_ccColor4B const&, cocos2d::CCPoint const&) = mac 0x275310;
	virtual auto getStartColor() = mac 0x275610;
	virtual auto setStartColor(cocos2d::_ccColor3B const&) = mac 0x275620;
	virtual auto getEndColor() = mac 0x275670;
	virtual auto setEndColor(cocos2d::_ccColor3B const&) = mac 0x275640;
...
class cocos2d::CCProgressTimer : cocos2d::CCNodeRGBA {
	...
	virtual auto setColor(cocos2d::_ccColor3B const&) = mac 0x36c590;
...
class cocos2d::CCTransitionFade : cocos2d::CCTransitionScene {
	...
	virtual auto initWithDuration(float, cocos2d::CCScene*, cocos2d::_ccColor3B const&) = mac 0x8ea50, ios 0x12c260;
};
...
class cocos2d::extension::AssetsManager::Helper : cocos2d::CCObject {
	virtual auto update(float) = mac 0x2e8420;
};

class cocos2d::extension::AssetsManager {
	virtual auto checkUpdate() = mac 0x2e7200;
	virtual auto update() = mac 0x2e7e80;
};
...
class cocos2d::extension::CCScale9Sprite : cocos2d::CCNodeRGBA {
	...
	virtual auto setColor(cocos2d::_ccColor3B const&) = mac 0x213c20, ios 0x13f178;
	virtual auto updateDisplayedColor(cocos2d::_ccColor3B const&) = mac 0x213a20, ios 0x13f004;
...
class cocos2d::extension::CCControlButton : cocos2d::extension::CCControl {
	...
	virtual auto setColor(cocos2d::_ccColor3B const&) = mac 0x1aa0b0;
	...
	virtual auto setTitleColorForState(cocos2d::_ccColor3B, unsigned int) = mac 0x1a8f60;
...
class cocos2d::extension::ColorPickerDelegate {
	virtual auto colorValueChanged(cocos2d::_ccColor3B);
};
...
class cocos2d::extension::CCEditBoxImplAndroid : cocos2d::extension::CCEditBoxImpl {
	...
	virtual auto setFontColor(cocos2d::_ccColor3B const&);
	virtual auto setPlaceholderFont(char const*, int);
	virtual auto setPlaceholderFontColor(cocos2d::_ccColor3B const&);
...
class cocos2d::extension::CCControlColourPicker : cocos2d::extension::CCControl {
	virtual auto init();
	virtual auto ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*);
	virtual auto setColorValue(cocos2d::_ccColor3B const&);
};
